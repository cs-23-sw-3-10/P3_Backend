...
class BladeTaskLogicTest {
    ...
    void TestDateBeforeTodayWhenCreatingBladeTask() {
        //Arrange
        BladeTaskInput input = new BladeTaskInput(LocalDate.of(2021, 1, 1), LocalDate.of(2021, 1, 2), 1, 1, 1, 1, 1, "TestName", "TestType", null);
        //Act
    ...
    void TestCreationOfBladeTaskShouldReturnBladeTask() {
        ...
        BladeTaskInput input = new BladeTaskInput(LocalDate.of(2024, 1, 1), LocalDate.of(2022, 1, 2), 1, 1, 1, 1, 1, "TestName", "TestType", null);
        //Act
